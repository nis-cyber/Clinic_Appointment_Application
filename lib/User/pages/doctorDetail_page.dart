    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            CircleAvatar(
              backgroundImage: AssetImage(widget.doctor.profile),
              radius: 50,
            ),
            SizedBox(height: 16),
            Text(
            ...
            SizedBox(height: 8),
            Text(
              'Position: ${widget.doctor.position}',
              style: TextStyle(fontSize: 16),
            ),
            SizedBox(height: 8),
            Text(
              'Average Review: ${widget.doctor.averageReview}',
              style: TextStyle(fontSize: 16),
            ),
            SizedBox(height: 8),
            Text(
              'Total Reviews: ${widget.doctor.totalReview}',
              style: TextStyle(fontSize: 16),
            ),
            // Add more details as needed
          ],
